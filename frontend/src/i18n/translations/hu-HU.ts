export default {
  ...
  "home.bullet.a.description": "A Mediapult Transfer megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A Mediapult Transfer megosztáskezelőre mutató hivatkozás",
