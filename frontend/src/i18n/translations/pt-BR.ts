export default {
  ...
  "home.bullet.a.description": "Hospede o Mediapult Transfer em sua própria máquina.",
  ...
  "account.card.api-tokens.description": "Create tokens for desktop apps. The token is shown only once.",
  "account.card.api-tokens.created": "Copy this token now. It will not be shown again.",
  ...
  "admin.config.config-file-warning.description": "Como você tem um Mediapult Transfer configurado com um arquivo de configuração, você não pode alterar a configuração através da UI.",
  ...
  "admin.config.general.app-url.description": "Em qual URL o Mediapult Transfer está disponível",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente informações de caches Mediapult Transfer na memória. Se você executar várias instâncias do Mediapult Transfer, você precisa habilitar o cache do Redis para compartilhar o cache entre as instâncias.",
  ...
  "admin.config.share.default-expiration.description": "Default share expiration used by API clients when no expiration is provided.",
