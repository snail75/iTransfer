export default {
  ...
  "home.bullet.a.description": "Hostujte Mediapult Transfer na svém vlastním počítači.",
  ...
  "admin.config.config-file-warning.description": "Jelikož je Mediapult Transfer nastaven pomocí konfiguračního souboru, nemůžete změnit nastavení přes UI.",
  ...
  "admin.config.general.app-url.description": "Na kterém URL je Mediapult Transfer k dispozici",
