export default {
  ...
  "home.bullet.a.description": "Mediapult Transfer'i kendi sunucunuzda barındırın.",
  ...
  "admin.config.general.app-url.description": "Mediapult Transfer'in erişilebilir olduğu URL",
  ...
  "admin.config.cache.redis-enabled.description": "Normalde Mediapult Transfer bilgileri bellekte önbellekler. Birden fazla Mediapult Transfer örneği çalıştırıyorsanız, örnekler arasında önbelleği paylaşmak için Redis önbelleklemesini etkinleştirmeniz gerekir.",
