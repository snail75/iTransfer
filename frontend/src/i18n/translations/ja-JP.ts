export default {
  ...
  "home.bullet.a.description": "Mediapult Transferをあなたのマシンでホストしましょう。",
  ...
  "admin.config.general.app-url.description": "Mediapult Transferで利用できるURL",
  ...
  "admin.config.cache.redis-enabled.description": "通常、Mediapult Transfer は情報をメモリ内にキャッシュします。複数の Mediapult Transfer インスタンスを実行する場合は、インスタンス間でキャッシュを共有するために Redis キャッシュを有効にする必要があります。",
