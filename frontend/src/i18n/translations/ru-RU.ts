export default {
  ...
  "home.bullet.a.description": "Mediapult Transfer работает на вашей машине.",
  ...
  "admin.config.general.app-url.description": "Адрес на котором доступен Mediapult Transfer",
