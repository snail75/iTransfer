export default {
  ...
  "home.bullet.a.description": "Hostujte Mediapult Transfer na svojoj mašini.",
  ...
  "admin.config.cache.redis-enabled.description": "Mediapult Transfer obično kešira informacije u memoriji. Ako pokrećete više instanci Mediapult Transfer-a, potrebno je da omogućite Redis keširanje kako bi se keš delio između instanci.",
