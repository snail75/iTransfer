export default {
  ...
  "home.bullet.a.description": "Φιλοξενήστε το Mediapult Transfer στο δικό σας μηχάνημα.",
  ...
  "admin.config.general.app-url.description": "Η διεύθυνση URL όπου το Mediapult Transfer είναι διαθέσιμο",
