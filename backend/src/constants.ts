...
export const CONFIG_FILE =
  process.env.CONFIG_FILE || path.join("..", "config.yaml");

export const DATA_DIRECTORY = process.env.DATA_DIRECTORY || "./data";
export const SHARE_DIRECTORY =
  process.env.UPLOAD_DIRECTORY ||
  path.join(DATA_DIRECTORY, "uploads", "shares");
export const UPLOAD_TEMP_DIRECTORY = path.join(
  DATA_DIRECTORY,
  "uploads",
  "_temp",
);
