export default {
  ...
  "home.bullet.a.description": "Hosti Mediapult Transfer oma seadmes.",
  ...
  "admin.config.general.app-url.description": "URL, mille kaudu Mediapult Transfer on kättesaadav",
