export default {
  ...
  "home.bullet.a.description": "Host Mediapult Transfer op uw eigen machine.",
  ...
  "upload.dropzone.button.select": "Bestanden selecteren",
  ...
  "admin.config.general.app-url.description": "De URL waar Mediapult Transfer bereikbaar is",
