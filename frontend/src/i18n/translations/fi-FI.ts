export default {
  ...
  "home.bullet.a.description": "Isännöi \"Mediapult Transfer\" omalla palvelimellasi.",
  ...
  "admin.config.general.app-url.description": "Millä URL-osoitteella Mediapult Transfer on saatavilla",
