export default {
  ...
  "home.bullet.a.description": "Mediapult Transfer працює на вашій машині.",
  ...
  "admin.config.general.app-url.description": "Адреса, на якій доступний Mediapult Transfer",
