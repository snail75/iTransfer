export default {
  ...
  "home.bullet.a.description": "Host Mediapult Transfer på din egen maskine.",
  ...
  "upload.dropzone.button.select": "Vælg filer",
  ...
  "admin.config.general.app-url.description": "På hvilken URL Mediapult Transfer er tilgængelig",
