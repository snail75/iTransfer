export default {
  ...
  "home.description":
    "Você realmente quer entregar seus dados a serviços de terceiros com termos difíceis de revisar e que podem permitir treinamento de IA ou direitos amplos de uso? Se não quiser lidar com páginas de termos legais, hospede o serviço você mesmo.",
  "home.bullet.a.name": "Auto-Hospedado",
  "home.bullet.a.description":
    "Hospede o Mediapult Transfer em sua própria máquina.",
  ...
  "account.card.api-tokens.title": "Tokens de API para desktop",
  "account.card.api-tokens.description":
    "Crie e gerencie tokens para aplicativos de desktop.",
  "account.card.api-tokens.created":
    "Token criado. Você pode copiá-lo agora ou mais tarde pela lista.",
  "account.card.api-tokens.create": "Criar token",
  "account.card.api-tokens.name-placeholder": "Aplicativo desktop",
  "account.card.api-tokens.name-label": "Nome do token",
  "account.card.api-tokens.last-used": "Último uso: {date}",
  "account.card.api-tokens.never-used": "Nunca usado",
  "account.card.api-tokens.unavailable":
    "Este token antigo não pode ser exibido novamente. Crie um novo token para poder copiá-lo mais tarde.",
  "account.notify.api-token.created": "Token de API criado",
  "account.notify.api-token.deleted": "Token de API excluído",
  "account.notify.api-token.updated": "Token de API atualizado",
  ...
  "account.shares.table.allow-uploads": "Permitir uploads",
  "account.shares.table.allow-versioning": "Permitir versões",
  "account.shares.action.information": "Informações do compartilhamento",
  "account.shares.action.copy-link": "Copiar link do compartilhamento",
  "account.shares.action.delete": "Excluir compartilhamento",
  "account.shares.action.edit": "Editar compartilhamento",
  "account.shares.notify.name-saved": "Salvo",
  // END /account/shares
  ...
  "account.reverseShares.action.copy-link":
    "Copiar link de compartilhamento reverso",
  "account.reverseShares.action.delete": "Excluir compartilhamento reverso",
  ...
  "admin.button.system": "Configuração do sistema",
  // END /admin
  // /admin/users
  ...
  "admin.users.table.storage-quota": "Cota de armazenamento",
  "admin.users.storage.unlimited": "Armazenamento ilimitado",
  ...
  "admin.shares.edit.delete.description":
    "Tem certeza que deseja excluir este compartilhamento?",
  "admin.shares.table.anonymous": "Anónimo",
  // END /admin/shares
  // /upload
  ...
  "upload.modal.allow-uploads": "Permitir uploads",
  "upload.modal.allow-versioning": "Permitir versões",
  ...
  "share.fileCount":
    "{count, plural, =1 {# arquivo} other {# arquivos}} - {size} (o arquivo ZIP pode ficar menor por causa da compressão)",
  ...
  "share.notify.file-version-replaced": "Versão do arquivo substituída",
  "share.upload-back.title": "Enviar arquivos de volta",
  "share.upload-back.replace-title": "Substituir arquivos existentes",
  "share.upload-back.button": "Enviar",
  "share.upload-back.dropzone-title":
    "Solte arquivos aqui para adicioná-los a este link",
  "share.upload-back.replace-hint":
    "Use o ícone de substituição ao lado de um arquivo para enviar uma nova versão.",
  // END /share/[id]
  // /share/[id]/edit
  ...
  "admin.config.config-file-warning.description":
    "Como você tem um Mediapult Transfer configurado com um arquivo de configuração, você não pode alterar a configuração através da UI.",
  "admin.config.title": "Configuração",
  "admin.config.empty-category.title":
    "Nenhuma opção de configuração encontrada",
  "admin.config.empty-category.description":
    "Esta categoria não tem configurações editáveis no banco de dados atual. Execute o seed de configuração e reinicie o backend se esta categoria foi adicionada recentemente.",
  ...
  "admin.config.general.app-url.description":
    "Em qual URL o Mediapult Transfer está disponível",
  ...
  "admin.config.general.session-duration.description":
    "Tempo após o qual um usuário deve iniciar a sessão novamente (padrão: 3 meses).",
  ...
  "admin.config.cache.ttl.description":
    "Tempo em segundo para manter a informação dentro do cache.",
  "admin.config.cache.max-items": "Máximo de itens",
  "admin.config.cache.max-items.description":
    "Número máximo de itens dentro do cache.",
  "admin.config.cache.redis-enabled": "Redis habilitado",
  "admin.config.cache.redis-enabled.description":
    "Normalmente informações de caches Mediapult Transfer na memória. Se você executar várias instâncias do Mediapult Transfer, você precisa habilitar o cache do Redis para compartilhar o cache entre as instâncias.",
  "admin.config.cache.redis-url": "URL do Redis",
  "admin.config.cache.redis-url.description":
    "Url para conectar à instância de Redis usada para cache.",
  ...
  "admin.config.share.max-expiration.description":
    "Expiração máxima de compartilhamento. Defina 0 para permitir expiração ilimitada.",
  "admin.config.share.default-expiration": "Expiração padrão",
  "admin.config.share.default-expiration.description":
    "Expiração padrão usada por clientes API quando nenhuma expiração é informada.",
  ...
  "admin.config.share.max-size.description":
    "Tamanho máximo do compartilhamento",
  "admin.config.storage.local-upload-path": "Caminho local de upload",
  "admin.config.storage.local-upload-path.description":
    "Caminho absoluto usado para novos uploads armazenados localmente. Compartilhamentos existentes mantêm o caminho atual. Deixe em branco para usar o diretório de dados padrão.",
  "admin.config.storage.migrate.title":
    "Mover compartilhamentos locais existentes",
  "admin.config.storage.migrate.description":
    "Move todas as pastas locais de compartilhamentos existentes para o caminho local configurado e atualiza os registros. Os links permanecem iguais. Faça isso quando não houver uploads grandes em andamento.",
  "admin.config.storage.migrate.button": "Mover compartilhamentos existentes",
  "admin.config.storage.migrate.confirm":
    "Mover todas as pastas locais de compartilhamentos existentes para o caminho configurado? Os links continuam ativos, mas nenhum upload grande deve estar em andamento.",
  "admin.config.storage.migrate.success":
    "{count} pastas de compartilhamento movidas para {path}. Os links existentes continuam ativos.",
  "admin.system.nav": "Sistema",
  "admin.system.open": "Abrir configuração do sistema",
  "admin.system.title": "Configuração do sistema",
  "admin.system.description":
    "Verifique a configuração ativa, os caminhos de armazenamento, a localização do banco de dados, o status SMTP e as migrações locais em um só lugar.",
  "admin.system.yaml.title": "Arquivo de configuração ativo",
  "admin.system.yaml.description":
    "Um arquivo config.yaml está ativo. Os valores do arquivo são somente leitura na interface, mas a migração local ainda pode ser iniciada para o caminho ativo.",
  "admin.system.panel.config": "Configuração",
  "admin.system.panel.database": "Banco de dados",
  "admin.system.panel.email": "E-mail",
  "admin.system.field.source": "Origem",
  "admin.system.field.config-file": "Arquivo de configuração",
  "admin.system.field.editable": "Editável",
  "admin.system.field.database-url": "URL do banco de dados",
  "admin.system.field.database-path": "Caminho do banco de dados",
  "admin.system.field.live-move": "Mover ao vivo",
  "admin.system.field.smtp-enabled": "SMTP ativo",
  ...
  "admin.system.field.temp-upload-path.description":
    "Reservado para dados temporários de upload. Arquivos permanentes dos compartilhamentos não são armazenados aqui. Durante uma migração, pastas temporárias de cópia são criadas dentro do caminho de destino e removidas após a verificação.",
  "admin.system.field.shares": "Compartilhamentos",
  "admin.system.field.data": "Dados",
  "admin.system.field.free-space": "Espaço livre",
  "admin.system.value.not-applicable": "Não aplicável",
  "admin.system.value.not-set": "Não definido",
  "admin.system.config-source.database": "Banco de dados e interface",
  "admin.system.config-source.yaml": "config.yaml",
  "admin.system.storage.title": "Caminho de armazenamento",
  "admin.system.storage.description":
    "Esta seção controla onde novos compartilhamentos locais são armazenados. Ela não move compartilhamentos existentes até você executar a migração abaixo.",
  "admin.system.storage.target-path-label": "Novo caminho de upload ativo",
  "admin.system.storage.target-path-help":
    "Salve este valor para torná-lo o caminho ativo para novos compartilhamentos locais. Use depois o assistente de migração se os compartilhamentos existentes também devem ser movidos para este caminho.",
  "admin.system.storage.validate": "Validar caminho",
  "admin.system.storage.validation.valid":
    "{path} permite escrita. Espaço disponível: {space}.",
  "admin.system.storage.save-success": "Caminho de armazenamento salvo",
  "admin.system.storage.advanced": "Configurações avançadas de armazenamento",
  "admin.system.migration.title": "Migração de armazenamento local",
  "admin.system.migration.description":
    "Execute primeiro um dry run, revise os compartilhamentos afetados e os problemas bloqueantes, depois inicie a migração explicitamente. Cada compartilhamento é copiado para uma pasta temporária dentro do caminho de destino, verificado, atualizado no banco de dados e então excluído da pasta antiga do compartilhamento.",
  "admin.system.migration.cleanup-source-roots.label":
    "Excluir pastas raiz antigas de upload se estiverem vazias",
  "admin.system.migration.cleanup-source-roots.description":
    "Depois que todas as pastas dos compartilhamentos forem movidas e excluídas do caminho antigo, a migração também tenta remover a pasta raiz antiga. Ela só é excluída se estiver vazia; pastas com arquivos não relacionados permanecem e são informadas como aviso.",
  ...
  "admin.system.migration.dry-run-ok":
    "Dry run concluído sem problemas bloqueantes.",
  "admin.system.migration.latest-job": "Último job de migração",
  "admin.system.migration.progress":
    "{done} de {total} compartilhamentos processados. Dados movidos: {bytes}.",
  "admin.system.migration.status.pending": "Pendente",
  "admin.system.migration.status.running": "Em execução",
  "admin.system.migration.status.cancel_requested": "Cancelamento solicitado",
  "admin.system.migration.status.cancelled": "Cancelada",
  "admin.system.migration.status.completed": "Concluída",
  "admin.system.migration.status.completed_with_warnings":
    "Concluída com avisos",
  "admin.system.migration.status.failed": "Falhou",
  "admin.system.migration.status.skipped": "Ignorada",
  "admin.system.migration.status.cleanup_failed": "Limpeza falhou",
  "admin.system.roots.title": "Raízes de armazenamento local",
  "admin.system.roots.summary":
    "{shares} compartilhamentos, {files} arquivos, {bytes} armazenados.",
  ...
  "admin.config.share.chunk-size.description":
    "Ajuste o tamanho do pedaço para seus uploads equilibrarem eficiência e confiabilidade de acordo com sua conexão com a internet. Pedaços menores podem aumentar as taxas de sucesso para conexões instáveis, enquanto partes maiores aceleram uploads para conexões estáveis.",
  ...
  "admin.config.smtp.email.description":
    "Endereço de e-mail de onde os e-mails são enviados",
  ...
  "admin.config.oauth.oidc-scope.description":
    "Escopos que devem ser solicitados a partir do provedor OpenID Connect.",
  ...
  "admin.config.notify.logo-success":
    "Logo atualizado com sucesso. Pode levar alguns minutos para ser atualizado no site.",
  ...
  "admin.config.s3.enabled.description":
    "Se o S3 deve ser usado para armazenar os arquivos compartilhados em vez do sistema de arquivo local.",
  ...
  "admin.config.s3.bucket-path.description":
    "O caminho padrão que deve ser usado para armazenar os arquivos no bucket S3.",
  "admin.config.s3.key": "Chave",
  "admin.config.s3.key.description":
    "A chave que permite a você acessar o bucket S3.",
  "admin.config.s3.secret": "Segredo",
  "admin.config.s3.secret.description":
    "O segredo que permite a você acessar o bucket S3.",
  "admin.config.s3.use-checksum": "Usar Checksum",
  "admin.config.s3.use-checksum.description":
    "Desligar para backends que não suportem checksum (por exemplo, B2).",
  "admin.config.category.storage": "Armazenamento",
  ...
  "admin.config.legal.enabled.description":
    "Exibir um link para imprimir e política de privacidade no rodapé.",
  "admin.config.legal.imprint-text": "Imprimir texto",
  "admin.config.legal.imprint-text.description":
    "O texto que deve ser mostrado na imagem. Suporta Markdown. Deixe em branco para vincular a página de impressão externa.",
  "admin.config.legal.imprint-url": "Imprimir URL",
  "admin.config.legal.imprint-url.description":
    "Se você já tem uma página impressa, você pode vinculá-la aqui ao invés de usar o campo de texto.",
  ...
  "admin.config.legal.privacy-policy-text.description":
    "O texto que deve ser mostrado na política de privacidade. Suporta Markdown. Deixe em branco para vincular a página de política de privacidade externa.",
